...
export const routes: Routes = [
  ...
  {
    path: 'dashboard',
    loadComponent: () => import('./src/app/features/dashboard/dashboard').then(m => m.DashboardComponent)
  },
  // Ruta para el Mapa (carga perezosa del componente standalone)
  {
    path: 'map',
    loadComponent: () => import('./src/app/features/map/map').then(m => m.MapComponent)
  },
  ...
  {
    path: 'add-place',
    loadComponent: () => import('./src/app/features/add-place/add-place').then(m => m.AddPlaceComponent)
  },
  // Ruta comodín para manejar URLs no encontradas (redirige al dashboard)
